...
public class Swagger implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.blz.admin.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("LMS-Admin",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("LMS-Admin", "http://blz.admin", "gvpavangv14@gmail.com"),
                "Apache 2.0",
